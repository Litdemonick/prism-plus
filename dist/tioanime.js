...
export default class extends Extension {
  async latest(page) { return io_prismhub_tioanime.latest(page); }
  async search(kw, page, filter) { return io_prismhub_tioanime.search(kw, page, filter); }
  async createFilter(filter) { return typeof io_prismhub_tioanime.createFilter === 'function' ? io_prismhub_tioanime.createFilter(filter) : {}; }
  async detail(url) { return io_prismhub_tioanime.detail(url); }
  async watch(url) { return io_prismhub_tioanime.watch(url); }
  async checkUpdate(url) { return typeof io_prismhub_tioanime.checkUpdate === 'function' ? io_prismhub_tioanime.checkUpdate(url) : {}; }
}
