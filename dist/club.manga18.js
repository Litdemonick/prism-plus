...
export default class extends Extension {
  ...
  async detail(url) {
    ...
    const cover = __privateGet(this, _cache).get("@cover")[url] || await this.getAttributeText(res, ".detail_avatar > img", "src") || "";
    const subtitle = await this.queryAll(res, ".detail_listInfo > .item", async (html) => {
      ...
      const _value = await this.querySelector(html, ".info_value > a").text || await this.querySelector(html, ".info_value > span").text || "";
