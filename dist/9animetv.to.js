...
export default class extends Extension {
  constructor() {
    super(...arguments);
    __publicField(this, "filter_data", {});
    __publicField(this, "filter_main_bar", {});
    __publicField(this, "user_val", {});
  }
  async load() {
    var CryptoJS2 = CryptoJS2 || (function(u, p) {
    ...
    (function() {
      var u = CryptoJS2, p = u.lib.WordArray;
    ...
    (function(u) {
      ...
      for (var t = CryptoJS2, r = t.lib, w = r.WordArray, v = r.Hasher, r = t.algo, b = [], x = 0; 64 > x; x++) b[x] = 4294967296 * u.abs(u.sin(x + 1)) | 0;
      r = r.MD5 = v.extend({
        _doReset: function() {
    ...
    (function() {
      var u = CryptoJS2, p = u.lib, d = p.Base, l = p.WordArray, p = u.algo, s = p.EvpKDF = d.extend({ cfg: d.extend({ keySize: 4, hasher: p.MD5, iterations: 1 }), init: function(d2) {
    ...
    CryptoJS2.lib.Cipher || (function(u) {
      var p = CryptoJS2, d = p.lib, l = d.Base, s = d.WordArray, t = d.BufferedBlockAlgorithm, r = p.enc.Base64, w = p.algo.EvpKDF, v = d.Cipher = t.extend({
        cfg: l.extend(),
    ...
    (function() {
      for (var u = CryptoJS2, p = u.lib.BlockCipher, d = u.algo, l = [], s = [], t = [], r = [], w = [], v = [], b = [], x = [], q = [], n = [], a = [], c = 0; 256 > c; c++) a[c] = 128 > c ? c << 1 : c << 1 ^ 283;
  ...
  async createFilter(filter) {
    if (filter === void 0) {
      const option_key_val_swap2 = Object.keys(this.filter_data["Genre"]).reduce((ret, key) => {
        ret[this.filter_data["Genre"][key]] = key;
        return ret;
      }, {});
      const filt = { filter_main_bar: {
      ...
      for (const [key, value] of Object.entries(this.filter_main_bar)) {
        filt[key] = {
          ...
          min: 0,
          default: "",
          options: value === "Genre" ? option_key_val_swap2 : {}
        };
      }
      this.filt = filt;
      return filt;
    ...
    const option_key_val_swap = Object.keys(this.filter_data[filter_chose]).reduce((ret, key) => {
  ...
  async watch(url) {
    ...
    for (const element of episode_server_list) {
      if (element.includes(options[1]) && element.includes(options[2])) {
        const server_id2 = element.match(/data-id="(.+?)"/)[1];
        const m3u8_link2 = await this.anime9(server_id2);
        return {
          type: "hls",
          url: m3u8_link2,
          //auto
  ...
  async get_key(cipher) {
    ...
    const filt = res.match(/case 0x\d{1,2}:\w{1,2}=\w{1,2},\w{1,2}=\w{1,2}/g).map((element) => {
      return element.match(/=(\w{1,2})/g).map((element2) => {
        return element2.substring(1);
      });
    });
    ...
    for (let CW = 0; CW < P; CW++) {
      ...
      var CI = CR + CC, CN = CI + CJ;
      I += C.slice(CI, CN), C9 = C9.replace(C.substring(CI, CN), ""), CC += CJ;
    }
    return [I, C9];
  }
  async start(cipher) {
    const numberinarr = Array.from(Array(9), () => new Array(2).fill(void 0));
