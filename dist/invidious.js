...
var io_prismhub_invidious = (() => {
  ...
  async function detail(url) {
    const v = await getJson(`${API}/videos/${url}`);
    return {
      title: v.title,
      cover: bestThumb(v.videoThumbnails),
...
;(function(){
  ...
  var _m=typeof io_prismhub_invidious!=='undefined'?io_prismhub_invidious:null;
