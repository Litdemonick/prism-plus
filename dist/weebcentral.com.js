...
export default class extends Extension {
  ...
  async detail(url) {
    ...
    const htmlChaplist = fullChapsUrl ? await this.request("", { headers: { "Miru-Url": fullChapsUrl } }) : await this.querySelector(res, "#chapter-list").outerHTML;
  ...
  async watch(url) {
    ...
    let html = await this.querySelectorAll(
      res,
      "section > img"
    );
