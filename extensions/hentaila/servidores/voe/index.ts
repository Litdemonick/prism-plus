...
//
//   embed   https://voe.sx/e/irsyvjqxl5fn
//   sale    https://ugc-cdn-caching-n3zozs0yofvurnsojd.cloudwindow-route.com/…m3u8
//   tarda   480–800 ms (son dos pedidos: el de voe.sx y el del espejo)
//   se abre 200 application/vnd.apple.mpegurl
//
// **Es el único de los siete que el camino genérico NO saca** (comprobado: el
// genérico y el de streamwish devuelven null contra el mismo embed). O sea que
// este resolver no es redundante: si se borra, Voe pasa al navegador.
//
