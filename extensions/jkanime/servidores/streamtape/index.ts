// ─── StreamTape ⚡ nativo ─────────────────────────────────────────────────────
//
// Medido el 2026-08-05 sobre 3 episodios: resuelve 3 de 3 y reproduce 2 de 3
// (el que no, fue el archivo, no el resolver). **59 botones** en 59 episodios.
//
//   embed   https://streamtape.com/e/ZKx3OPV90LCqLyR/…
...
//
// Es lo ÚNICO que jkanime todavía sacaba de `sdk/embeds.ts` para un servidor
// (junto con el genérico, en la carpeta de al lado). Todo lo demás —voe,
// streamwish, vidhide, mixdrop, mp4upload, Desu y Magi— esta extensión ya lo
// resuelve con código propio desde hace rato, así que no se movió nada de eso:
// anda, y moverlo era riesgo sin ganancia.
//
