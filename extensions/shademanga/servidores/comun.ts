// ─── Piezas compartidas por los servidores de shademanga ─────────────────────
//
...
// shademanga — ninguna otra extensión las toca.
...
export async function pedir(
  ...
  try {
    ...
    console.log(`[sm] no se pudo pedir ${url.slice(0, 45)} :: ${(e as Error)?.message ?? e}`);
    return null;
  }
}
