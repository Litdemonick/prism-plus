// ─── Voe ⚡ nativo ────────────────────────────────────────────────────────────
//
// Traído desde hentaila, tal cual. Acá aparece ADENTRO de unlimplay: su menú
// interno ofrece un voe.sx propio, y hasta ahora eso obligaba a abrir el
// navegador. Con el resolver copiado sale como botón nativo.
//
// El camino genérico NO lo saca (medido en hentaila, mismo resolver): si este
// se borra, Voe vuelve al navegador.
//
